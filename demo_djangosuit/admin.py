...
# adapted from the official django-suit-demo_djangosuit
# see  https://github.com/darklow/django-suit-demo_djangosuit/blob/master/admin.py
...
class CityInlineForm(ModelForm):
    class Meta:
        widgets = {
            'area': EnclosedInput(prepend='icon-globe',
                                  append='km<sup>2</sup>',
...
class CountryAdmin(ModelAdmin):
    ...
    suit_form_includes = (
        ('admin/demo_djangosuit/country/tab_disclaimer.html', 'middle', 'cities'),
        ('admin/demo_djangosuit/country/tab_flag.html', '', 'flag'),
        ('admin/demo_djangosuit/country/tab_info.html', '', 'info'),
    )
...
#------------------------------------------------------------------------------
# Django-select2 integration demo_djangosuit
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Wysiwyg editor integration demo_djangosuit
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# django-reversion integration demo_djangosuit
#------------------------------------------------------------------------------
