...
# see  https://github.com/darklow/django-suit-demo_djangosuit/blob/master/models.py
...
class KitchenSink(models.Model):
    ...
    choices = models.SmallIntegerField(choices=TYPE_CHOICES3,
                                       default=3,
                                       help_text="Help text")
    hidden_checkbox = models.BooleanField(default=False)
...
class Fridge(models.Model):
    ...
    description = models.TextField(blank=True)
    is_quiet = models.BooleanField(default=True)
    order = models.PositiveIntegerField()
...
class Microwave(models.Model):
    ...
    is_compact = models.BooleanField(default=True)
    order = models.PositiveIntegerField()
...
##################################
#
# Integrations demo_djangosuit
#
# see http://django-suit.readthedocs.org/en/develop/sortables.html#django-mptt-tree-sortable
##################################
